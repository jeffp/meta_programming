...
Removes object parameter from method blocks and lambda matchers in define_ghost_method.
define_ghost_method block and matchers are now evaluated in the scope of the instance.
Adds more descriptive error handling.  I've bumped the version to 0.2.0 because this is a major change.

...
values in block parameters

  call_some_method(*args) do |param1, param2=nil|
    ...
  end

Additionally, Ruby 1.8 cannot handle a block in a block parameter list

  call_some_method(*args) do |param1, *args, &block|
    ...
  end
